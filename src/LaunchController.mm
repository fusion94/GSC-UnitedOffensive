...
// This method writes the config files and launches the game.
{
    ...
    if (paramsSaved) {
        ...
        [fileContents appendString:[NSString stringWithFormat:@"sets sv_master1 \"%@\"\n", [masterServer1 stringValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"sets sv_master2 \"%@\"\n", [masterServer2 stringValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"sets sv_master3 \"%@\"\n", [masterServer3 stringValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"sets sv_master4 \"%@\"\n", [masterServer4 stringValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"sets sv_master5 \"%@\"\n", [masterServer5 stringValue]]];
        ...
        [fileContents appendString:[NSString stringWithFormat:@"set sv_timeout \"%d\"\n", [setPlayerTimeOut intValue]]]; 
        ...
        [fileContents appendString:[NSString stringWithFormat:@"seta sv_gamespy \"%d\"\n", [ enableGameSpy intValue]]];

        // game tab items
        [fileContents appendString:[NSString stringWithFormat:@"set scr_bas_scorelimit \"%d\"\n", [bas_scoreLimit intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_bas_timelimit \"%d\"\n", [bas_timeLimit intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_bas_roundlimit \"%d\"\n", [bas_roundLimit intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_bas_roundlength \"%d\"\n", [bas_roundLength intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_bas_respawn_wave_time \"%d\"\n", [bas_respawnWaveTime intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_bas_startrounddelay \"%d\"\n", [bas_startRoundDelay intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_bas_endrounddelay \"%d\"\n", [bas_endRoundDelay intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_bas_clearscoreeachround \"%d\"\n", [bas_clearScoresEachRound intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_ctf_scorelimit \"%d\"\n", [ctf_scoreLimit intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_ctf_timelimit \"%d\"\n", [ctf_timeLimit intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_ctf_roundlimit \"%d\"\n", [ctf_roundLimit intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_ctf_roundlength \"%d\"\n", [ctf_roundLength intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_ctf_startrounddelay \"%d\"\n", [ctf_startRoundDelay intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_ctf_endrounddelay \"%d\"\n", [ctf_endRoundDelay intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_ctf_clearscoreeachround \"%d\"\n", [ctf_clearScoresEachRound intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_ctf_showoncompass \"%d\"\n", [ctf_showOnCompass intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_dom_scorelimit \"%d\"\n", [dom_scoreLimit intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_dom_timelimit \"%d\"\n", [dom_timeLimit intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_dom_roundlimit \"%d\"\n", [dom_roundLimit intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_dom_roundlength \"%d\"\n", [dom_roundLength intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_dom_respawn_wave_time \"%d\"\n", [dom_respawnWaveTime intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_dom_startrounddelay \"%d\"\n", [dom_startRoundDelay intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_dom_endrounddelay \"%d\"\n", [dom_endRoundDelay intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_dom_clearscoreeachround \"%d\"\n", [dom_clearScoresEachRound intValue]]];
        ...
        [fileContents appendString:[NSString stringWithFormat:@"set g_allowvotetempbanuser \"%d\"\n", [allowVoteBanUser intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set g_allowvotekick \"%d\"\n", [allowVoteKickUser intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set g_allowvotegametype \"%d\"\n", [allowVoteGameType intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set g_allowvotetypemap \"%d\"\n", [allowVoteTypeMap intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set g_allowvotemap \"%d\"\n", [allowVoteMap intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set g_allowvotemaprotate \"%d\"\n", [allowVoteNextMap intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set g_allowvotemaprestart \"%d\"\n", [allowVoteRestartMap intValue]]];
        ...
        [fileContents appendString:[NSString stringWithFormat:@"set scr_shellshock \"%d\"\n", [enableShellShock intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_drophealth \"%d\"\n", [enableHealthDrop intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_battlerank \"%d\"\n", [enableBattleRank intValue]]];
        ...
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_pistols \"%d\"\n", [weaponPistols intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_satchel \"%d\"\n", [weaponSatchel intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_smoke \"%d\"\n", [weaponSmoke intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_grenades \"%d\"\n", [weaponGrenades intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_flamethrower \"%d\"\n", [weaponFlamethrower intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_artillery \"%d\"\n", [weaponArtillery intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_bazooka \"%d\"\n", [weaponBazooka intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_mg30cal \"%d\"\n", [weaponMg30 intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_dp28 \"%d\"\n", [weaponDp28 intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_svt40 \"%d\"\n", [weaponSvt40 intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_mg34 \"%d\"\n", [weaponMg34 intValue]]];
        [fileContents appendString:[NSString stringWithFormat:@"set scr_allow_gewehr43 \"%d\"\n", [weaponGewehr43 intValue]]];
 ...
 //       NSLog(@"-------------RUNNING & POLLING FOR EXIT-------------");
        ...
        while (!gameHasTerminated) {
            ...
            if ([self gameProcessRuns]) { // while the game still runs
                // check if we need to kill it
                if (weHaveToQuit) {
                    [manServerStatus setStringValue: MAN_GOINGDOWN]; // set statusmessage
                    NSLog(@"Trying to kill the server...");
                    [self talkToServer:@"quit" reply:NO]; // send a quit command to the server
                }
                ...
                if ([pollDate timeIntervalSinceDate:[NSDate date]] < 0) { // is it time to poll?
                  //  NSLog(@"POLLING NOW!");
                    ...
                    if (([enableAutoKick intValue] == 1) && (!weHaveToQuit)){
                        [self autoKickPlayers]; // auto kick players
                    }
                    
                    // do leading player message if necessary
                    if (([leadMessEnabled state]) && ([playerArray count] > 0) && (!weHaveToQuit)) {
                        ...
                        if (otherScoresFound) {
                            ...
                            for (lead = 1; lead < [playerArray count]; lead++) {
                                if ([[[playerArray objectAtIndex:lead] objectAtIndex:2] intValue] == bestScore) {
                                    [bestPlayer appendString:@" ^3& "]; // append the name
                            ...
                            for (lead = 0; lead < [playerArray count]-1; lead++) {
                                if ([[[playerArray objectAtIndex:lead] objectAtIndex:2] intValue] == worstScore) {
                                    [worstPlayer appendString:@" ^3& "]; // append the name
                ...
                if (([servMessEnabled state]) && (!weHaveToQuit)) {
...
//        NSLog(@"Talking...");
        ...
        talkingFlag = NO;
        [returnString setString:rxString]; // set the return string
    } else {
        NSLog(@"Cannot talk now...");
        [returnString setString:@" "]; // return an empty string
    }
    
    // wait a second to enable sockets to close properly
